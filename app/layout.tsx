  ...
  return (
    <html lang="en" className="h-full antialiased" data-scroll-behavior="smooth" suppressHydrationWarning>
      ...
      <body className="flex min-h-full flex-col bg-white text-neutral-900 transition-colors dark:bg-neutral-950 dark:text-neutral-50">
        <Header profile={siteData.profile} theme={siteData.themeToggle} animations={siteData.animationToggle} links={siteData.links} />
        ...
        <Footer footer={siteData.footer} links={siteData.links} />
      </body>
    </html>
  );
}
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        onClick={toggle}
        className="inline-flex h-5 w-9 shrink-0 items-center rounded-full bg-neutral-300 p-0.5 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-400 dark:bg-neutral-600 cursor-pointer"
      >
        <span
